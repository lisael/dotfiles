...
local taglist_buttons = awful.util.table.join(
                    awful.button({ }, 1, function(t) view_only(t) end),
                    ...
                    awful.button({ }, 4, function(t) view_next_tag(t.screen) end),
                    awful.button({ }, 5, function(t) view_prev_tag(t.screen) end)
                )
...
globalkeys = awful.util.table.join(
    ...
    awful.key({ modkey,           }, "Escape", restore_tag,
